...
public class AnnotationPrinter extends CasConsumer_ImplBase implements CasObjectProcessor {
  ...
  public void initialize() throws ResourceInitializationException {
    ...
    logger.log(Level.CONFIG, "CasConsumer: AnnotationPrinter initialized.");
  ...
  public synchronized void processCas(CAS aCAS) throws ResourceProcessException {
    ...
    Iterator qaIter = jcas.getAnnotationIndex(QASystemOutput.type).iterator();
    QASystemOutput qaSystemOutput = null;
    ...
    while (qaIter.hasNext()) {
      ...
      try {
        fileWriter.write("Question: " + question.getCoveredText() + "\n");
      ...
      nDoc++;
      avgPrecision += qaSystemOutput.getPrecisionAtK();
    }
  ...
  public void collectionProcessComplete(ProcessTrace aTrace) throws ResourceProcessException,
    ...
    fileWriter.write("Average Precision: " + this.roundTwoDecimals(avgPrecision / nDoc));
    if (fileWriter != null) {
      fileWriter.close();
    }
  }
